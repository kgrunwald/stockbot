    ...
    return Column(
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            Container(
              ...
              child: charts.PieChart(seriesData(context), 
                animate: false,
              ...
              children: <TableRow>[
                TableRow(
                  children: <Widget>[
                    ...
                    Text(Format.currency.format(stockPosition.marketValue), style: detailTextStyle, textAlign: TextAlign.end),
                  ]
                ),
                TableRow(
                  children: <Widget>[
                    ...
                    Text(Format.currency.format(bondPosition.marketValue), style: detailTextStyle, textAlign: TextAlign.end),
                  ]
                ),
                TableRow(
                  children: <Widget>[
                    ...
                    Text(Format.currency.format(acctDetails.cashBalance), style: detailTextStyle, textAlign: TextAlign.end,),
                  ]
                )
              ],
            ),
        ...
        DetailTable(
          ...
          children: acctDetails.orders.map((order) => DetailTable.stockOrderRow(order.symbol, order.side, order.formattedTime, order.quantity, order.price)).toList()
        )
      ],
    );
  }
