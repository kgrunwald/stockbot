        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Container(
                width: 180,
                child: StockStatus(stock: status.bondPosition)
              ),
            ],
          ),
          Row(
              ...
              Container(
                ...
                child: DetailTable(
                  children: [
                    ...
                    DetailTable.textRow(status.differenceFromTarget >= 0 ? "Surplus" : "Shortfall", Format.currency.format(status.differenceFromTarget)),
                    ...
                    DetailTable.textRow("TQQQ Action", "${status.stockAction} ${status.stockAction != "None" ? status.stockActionAmount : ""}"),
                  ],
                ),
              ),
              Container(
                ...
                child: DetailTable(
                  children: [
                    ...
                    DetailTable.textRow("AGG Action", "${status.bondAction} ${status.bondAction != "None" ? status.bondActionAmount : ""}"),
                  ],
                ),
              )
            ],
