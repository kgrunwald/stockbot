    ...
    for attr in attrs:
        ...
        if hasattr(definition, 'description'):
            ...
            if field_type.startswith('String'):
                attr_dict[attr] = fields.String(description=definition.description, required=definition.required)
            elif field_type.startswith('Integer'):
                attr_dict[attr] = fields.Integer(description=definition.description, required=definition.required)
            else:
